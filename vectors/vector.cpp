...
bool test_vector3d(vector <vector3d> Vec, vector3d v1, vector3d v2, float v3) {
    ...
    for (int i = 0; i < Vec.size(); ++i) {
        ...
        case 1:
            if ((Vec[i][0] == (v1[0] - v2[0])) && (Vec[i][1] == (v1[1] - v2[1])) && (Vec[i][2] == (v1[2] - v2[2])))
                cerr << "бинарная разность  векторов " << v1 << " и " << v2 << " - Правильно" << endl;
            else
            {
                cerr << "бинарная разность векторов " << v1 << " и " << v2 << " - Неверно" << endl;
                check = false;
            }
            break;
        case 2:
            if ((Vec[i][0] == (v1[0] * v3)) && (Vec[i][1] == (v1[1] * v3)) && (Vec[i][2] == (v1[2] * v3)))
                cerr << "бинарная операция умножения вектора на сколяр " << v1 << " на " << v3 << " - Правильно" << endl;
            else
            {
                check = false;
                cerr << "бинарная операция умножения вектора на сколяр " << v1 << " на " << v3 << " - Неверно" << endl;
            }
            break;
        case 3:
            if ((Vec[i][0] == (v1[0] / v3)) && (Vec[i][1] == (v1[1] / v3)) && (Vec[i][2] == (v1[2] / v3)))
                cerr << "бинарная операция деление вектора на сколяр " << v1 << " на " << v3 << " - Правильно" << endl;
            else
            {
                check = false;
                cerr << "бинарная операция деления вектора на сколяр " << v1 << " на " << v3 << " - Неверно" << endl;
            }
            break;
        case 4:
            if ((Vec[i][0] == (-v1[0])) && (Vec[i][1] == (-v1[1])) && (Vec[i][2] == (-v1[2])))
                cerr << "унарная операция инвертирования знака вектора  " << v1 << " - Правильно" << endl;
            else
            {
                check = false;
                cerr << "унарная операция инвертирования знака вектора  " << v1 << " - Неверно" << endl;
            }
            break;
