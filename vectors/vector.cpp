...
bool test_vector3d()
{
    ...
    {
        cerr << "ќшибка в операции сложени€ векторов";
        return 1;
    }
    if (v5.data[0] != 2 || v5.data[1] != 2 || v5.data[2] != 2)
    {
        cerr << "ќшибка в операции разности векторов";
        return 1;
    }
    if (v6.data[0] != 20 || v6.data[1] != 20 || v6.data[2] != 20)
    {
        cerr << "ќшибка в операции умножени€ вектора на скал€р";
        return 1;
    }
    if (v7.data[0] != 2 || v7.data[1] != 2 || v7.data[2] != 2)
    {
        cerr << "ќшибка в операции делени€ вектора на скал€р";
        return 1;
    }
    if (v8.data[0] != -2 || v8.data[1] != -2 || v8.data[2] != -2)
    {
        cerr << "ќшибка в операции инвертировани€ знака вектора";
        return 1;
    }
    if (v9.data[0] != 0 || v9.data[1] != 0 || v9.data[2] != 0)
    {
        cerr << "ќшибка в логическом преобразовании";
        return 1;
    }
