...
bool vector3d_AdditionTest(vector3d v1, vector3d v2) {
	vector3d res = v1 + v2;
...
bool vector3d_SubstructionTest(vector3d v1, vector3d v2) {
	vector3d res = v1 - v2;
...
bool vector3d_MultiTest(vector3d v1, float scal) {
...
bool vector3d_DivTest(vector3d v1, float scal) {
	vector3d res = v1 / scal;
...
bool vector3d_DenialTest(vector3d v) {
	vector3d res = -v;
...
bool vector3d_BoolTest(vector3d v) {
	vector3d res = !v;
...
bool test_vector3d() {
	...
	res1 = vector3d_AdditionTest(v_value1, v_value2);
	res2 = vector3d_SubstructionTest(v_value1, v_value2);
	res3 = vector3d_MultiTest(v_value1, 1.5);
	std::cout << "Division by zero - ";
	res4 = vector3d_DivTest(v_value1, 0);
	res5 = vector3d_DivTest(v_value1, 2);
	res6 = vector3d_DenialTest(v_value1);
	res7 = vector3d_BoolTest(v_null);
	res8 = vector3d_BoolTest(v_value1);
