...
public:
    void set_life_expectancy(int NewLifeExpectancy) { life_expectancy = NewLifeExpectancy; }
...
public:
    void set_pregnancy_duration(int new_pregnancy_Duration) { pregnancy_duration = new_pregnancy_Duration; }
