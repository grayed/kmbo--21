...
Bar::Bar()
{
    std::cerr << "constructed object #" << _id << " at " << this << " but this is Bar" << std::endl;
}

Bar::~Bar()
{
    std::cerr << "destructed object #" << _id << " at " << this << " but this is Bar" << std::endl;
}
...
Buz::Buz()
{
    std::cerr << "constructed object #" << _id << " at " << this << " but this is Buz" << std::endl;
}

Buz::~Buz()
{
    std::cerr << "destructed object #" << _id << " at " << this << " but this is Buz" << std::endl;
}
